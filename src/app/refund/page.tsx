...
export default function RefundPage() {
  return (
    <LegalPage title="Refund & Cancellation Policy" updated="September 2026">
      <h2 className="font-display text-lg font-bold text-navy">Cancellations</h2>
      <p>
      ...
      <h2 className="font-display text-lg font-bold text-navy">Before service begins</h2>
      <p>
        If you cancel a confirmed booking before our team arrives or before work begins,
        any advance paid will be refunded in full.
      </p>

      <h2 className="font-display text-lg font-bold text-navy">After service begins</h2>
      <p>
      ...
      <h2 className="font-display text-lg font-bold text-navy">Satisfaction</h2>
      <p>
