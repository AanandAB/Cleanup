...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Use" updated="September 2026">
      ...
      <h2 className="font-display text-lg font-bold text-heading">Services</h2>
      <p>
      ...
      <h2 className="font-display text-lg font-bold text-heading">Estimates &amp; pricing</h2>
      <p>
      ...
      <h2 className="font-display text-lg font-bold text-heading">Customer responsibilities</h2>
      ...
      <h2 className="font-display text-lg font-bold text-heading">Liability</h2>
      <p>
      ...
      <h2 className="font-display text-lg font-bold text-heading">Governing law</h2>
      <p>
        These terms are governed by the laws of India, with courts in Kerala having
        jurisdiction.
      </p>

      <h2 className="font-display text-lg font-bold text-heading">Changes</h2>
      <p>
